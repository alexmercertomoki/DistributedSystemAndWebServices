...
public class TCPSpyCommanderUsingTEAandPasswords {
	 ...
	 */
	public TCPSpyCommanderUsingTEAandPasswords(byte[] key) {
		if (key == null)
	...
	public static void main(String[] args) {
		...
		TCPSpyCommanderUsingTEAandPasswords tea = new TCPSpyCommanderUsingTEAandPasswords("And is there honey still for tea?".getBytes());
